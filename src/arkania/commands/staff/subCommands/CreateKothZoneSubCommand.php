...
class CreateKothZoneSubCommand extends BaseSubCommand {
	...
	public function onRun(CommandSender $player, array $args) : void {
		...
		KothManager::getInstance()->setPositions(Position1SubCommand::$pos1, Position2SubCommand::$pos2);
        KothManager::getInstance()->createKothZone();
		$player->sendMessage(CustomTranslationFactory::arkania_koth_created());
	}
}
