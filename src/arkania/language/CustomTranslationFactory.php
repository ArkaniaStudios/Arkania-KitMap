...
final class CustomTranslationFactory{
	public static function arkania_area_admin_disable() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_ADMIN_DISABLE, []);
	}

	public static function arkania_area_admin_enable() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_ADMIN_ENABLE, []);
	}

	public static function arkania_area_already_exist(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_ALREADY_EXIST, [
			0 => $param0,
		]);
	}

	public static function arkania_area_created(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_CREATED, [
			0 => $param0,
		]);
	}

	public static function arkania_area_delete_success(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_DELETE_SUCCESS, [
			0 => $param0,
		]);
	}

	public static function arkania_area_list(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_LIST, [
			0 => $param0,
		]);
	}

	public static function arkania_area_not_exist(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_NOT_EXIST, [
			0 => $param0,
		]);
	}

	public static function arkania_area_param_changed(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_PARAM_CHANGED, [
			0 => $param0,
		]);
	}

	public static function arkania_area_reload() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_RELOAD, []);
	}

	public static function arkania_area_select_pos1() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_SELECT_POS1, []);
	}

	public static function arkania_area_select_pos2() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_AREA_SELECT_POS2, []);
	}

	public static function arkania_ban_already_banned(Translatable|string $param0) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_BAN_ALREADY_BANNED, [
			0 => $param0,
		]);
	}
	...
	public static function arkania_kick_broadcast(Translatable|string $param0, Translatable|string $param1) : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_KICK_BROADCAST, [
			0 => $param0,
			1 => $param1,
		]);
	}

	public static function arkania_kick_description() : Translatable{
	...
	public static function arkania_money_topmoney_description() : Translatable{
		return new Translatable(CustomTranslationKeys::ARKANIA_MONEY_TOPMONEY_DESCRIPTION, []);
	}
